...
int main(int argc, char **argv)
{
    ...
    printf("cpu reduce      elapsed %ld nano sec cpu_sum: %d\n", elaps, cpu_sum);
    ...
    printf("gpu Neighbored  elapsed %ld nano sec gpu_sum: %d <<<grid %d block "
    ...
    printf("gpu Neighbored2 elapsed %ld nano sec gpu_sum: %d <<<grid %d block "
           "%d>>>\n", elaps, gpu_sum, grid.x, block.x);
    ...
    printf("gpu Interleaved elapsed %ld nano sec gpu_sum: %d <<<grid %d block "
           "%d>>>\n", elaps, gpu_sum, grid.x, block.x);
    ...
    printf("gpu Unrolling2  elapsed %ld nano sec gpu_sum: %d <<<grid %d block "
    ...
    printf("gpu Unrolling4  elapsed %ld nano sec gpu_sum: %d <<<grid %d block "
    ...
    printf("gpu Unrolling8  elapsed %ld nano sec gpu_sum: %d <<<grid %d block "
    ...
    printf("gpu UnrollWarp8 elapsed %ld nano sec gpu_sum: %d <<<grid %d block "
           "%d>>>\n", elaps, gpu_sum, grid.x / 8, block.x);
    ...
    printf("gpu Cmptnroll8  elapsed %ld nano sec gpu_sum: %d <<<grid %d block "
           "%d>>>\n", elaps, gpu_sum, grid.x / 8, block.x);
    ...
    printf("gpu Cmptnroll   elapsed %ld nano sec gpu_sum: %d <<<grid %d block "
           "%d>>>\n", elaps, gpu_sum, grid.x / 8, block.x);
