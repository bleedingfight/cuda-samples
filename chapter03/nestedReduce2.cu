...
int main(int argc, char **argv)
{
    ...
    printf("gpu nested\t\telapsed %ld nano sec gpu_sum: %d <<<grid %d block %d>>>\n",
           elaps, gpu_sum, grid.x, block.x);
    ...
    printf("gpu nestedNosyn\t\telapsed %ld nano sec gpu_sum: %d <<<grid %d block "
           "%d>>>\n", elaps, gpu_sum, grid.x, block.x);
    ...
    printf("gpu nested2\t\telapsed %ld nano sec gpu_sum: %d <<<grid %d block %d>>>\n",
           elaps, gpu_sum, grid.x, block.x);
